...
ARG projname=card-helper
ARG profile=card-helper.pro

RUN cd / && git clone https://github.com/homdx/android_openssl.git && cd /android_openssl && git checkout 5.12.4_5.13.0 && mkdir -pv /app/${projname}
